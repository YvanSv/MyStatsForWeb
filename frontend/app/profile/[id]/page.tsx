      ...
      <div className="max-w-6xl mx-auto px-6 -mt-24 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-end gap-6 mb-12">
          ...
          <div className="flex-1 mb-4">
            <h1 className="text-s-titre text-white leading-none mb-2">{profile.display_name}</h1>
            <p className="text-vert font-hias tracking-[0.2em] text-sm uppercase">Membre Premium</p>
          </div>
          <button className="mb-4 px-8 py-3 bg-white/5 hover:bg-white/10 border border-white/10 backdrop-blur-md rounded-2xl text-white transition-all active:scale-95">
            Partager le profil
          </button>
        </div>
